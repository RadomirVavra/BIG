...
namespace big
{
    ...
    const std::vector<ChunkIds> CoreChunkIds = { ChunkIds::NUMBER_OF_IMAGES, ChunkIds::IMAGE_HEIGHT, ChunkIds::IMAGE_WIDTH, ChunkIds::NUMBER_OF_PLANES, ChunkIds::DATA_ORDER, ChunkIds::XML, ChunkIds::DATA };
